 ...
 */
export declare function createWebhookRouter(verifyToken: string | undefined, onPayload?: (body: unknown) => void, checkVerifyToken?: VerifyTokenChecker, onVerifyTokenSuccess?: VerifyTokenSuccessHandler): Router;
export {};
